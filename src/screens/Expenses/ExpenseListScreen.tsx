...
import { fetchExpensesByGroupId } from "../../api/expenseService";
...
export default function ExpenseListScreen({ route, navigation }: Props) {
    ...
    const { data: expenses, isLoading } = useQuery({
        queryKey: groupId ? ["expenses", groupId] : ["expenses", "all"],
        queryFn: () =>
            groupId ? fetchExpensesByGroupId(groupId) : fetchAllExpenses(),
    });
